...
// Premium shimmer skeleton for feed loading
const FeedSkeleton = () => (
...
// Shimmer skeleton for course list loading
...
// Dynamic imports with shimmer fallbacks
    ...
    return (
        <div className="min-h-screen bg-[#f7f6ff] dark:bg-slate-950 pb-28 md:pb-8">
            <div className="p-4 md:p-8">
                {/* flex-col-reverse: on mobile, sidebar (stats) shows FIRST, feed shows SECOND */}
                <div className="flex flex-col-reverse lg:grid lg:grid-cols-12 gap-6 lg:gap-8">

                    {/* ── Main Feed Column (bottom on mobile, left on desktop) ── */}
                    ...
                    {/* ── Sidebar Column (top on mobile, right on desktop) ── */}
                    <div className="lg:col-span-4 space-y-5">
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-3">
                                ...
                                <Link href="/courses">
                                    <Button variant="ghost" size="sm" className="text-violet-600 dark:text-violet-400 hover:text-violet-700 h-8 text-xs px-2">
                                        View All
                                    </Button>
                                </Link>
                            </div>
                            ...
                            {coursesInProgress.length > 0 ? (
                                ...
                                <div className="text-center p-8 border border-dashed border-violet-200 dark:border-violet-800/50 rounded-2xl bg-violet-50/50 dark:bg-violet-950/20">
                                    ...
                                    <Link href="/courses" className="text-sm font-bold text-violet-600 dark:text-violet-400 hover:underline mt-2 inline-block">
                                        Browse Courses →
                                    </Link>
                                </div>
                            )}
