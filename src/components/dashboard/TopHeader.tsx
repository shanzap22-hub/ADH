...
export const TopHeader = () => {
    ...
    return (
        <header className="fixed top-0 left-0 right-0 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 z-50 pt-[env(safe-area-inset-top)]">
